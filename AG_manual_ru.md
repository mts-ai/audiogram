...
| enhanced_vad_options | EnhancedVADOptions |  |
| target_speech_vad_options | TargetSpeechVADOptions |  |
...
| Поле | Тип | Описание |
| :--- | :--- | :--- |
| beginning_window_ms | int32 |  |
| beginning_threshold | float |  |
| ending_window_ms | int32 |  |
...
| header | mts.ai.audiogram.stt_response.v1.ResponseHeader |  |
