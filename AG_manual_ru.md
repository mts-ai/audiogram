...
## Текущая версия - Audiogram 3.10.0

Обновление Audiogram 3.10.0 содержит следующие улучшения:
...
* Добавлена первичная поддержка сохранения/получения входящего аудиопотока на/с облачной платформы [extremum](https://extremum.io/) (данный функционал будет полностью реализован в следующих обновлениях).
* Добавлена первичная поддержка валидации токенов через PDP (policy decision point) (данный функционал будет полностью реализован в следующих обновлениях).
