...
| Имя | Значение | Описание |
| :--- | :--- | :--- |
| VAD_MODE_DEFAULT | 0 | Значение по умолчанию для распознавания в файловом режиме - ONLY_SPEECH, для распознавания в потоковом режиме - SPLIT_BY_PAUSES. |
...
## Текущая версия - Audiogram 3.24.0

Обновление Audiogram 3.24.0 содержит следующие улучшения и исправления:
* Улучшена ML-модель "Нормализатор чисел":
