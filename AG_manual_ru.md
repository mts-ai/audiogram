...
| Имя метода | Тип запроса | Тип ответа | Описание |
| :--- | :--- | :--- | :--- |
| Recognize | stream [RecognizeRequest](#recognizerequest) | stream [RecognizeResponse](#recognizeresponse) | Метод поточного распознавания. Принимает аудиоданные по мере их доступности. Распознавание заканчивается, когда поток закрывается клиентом. |
