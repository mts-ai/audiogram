...
Формат аудиоданных (кодировку) можно задать при вызове методов **FileRecognize**,  **Synthesize**, **VoiceCloning**,  в  поле **encoding**, которое возвращает тип перечисления **AudioEncoding**. Смотрите раздел **Справочник API**. 
