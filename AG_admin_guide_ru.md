...
Формат аудиоданных (кодировка) задается при вызове методов **FileRecognize**,  **Synthesize**, **VoiceCloning**  в  поле encoding, которое возвращает тип перечисления **AudioEncoding**. Смотрите раздел **Справочник API**. 
